...
Cf. document "[Major Changes](https://github.com/jross765/JGnuCashLibNTools/gnucash-viewer/major_changes.md)".
...
## Scope
Cf. document "[Scope](https://github.com/jross765/JGnuCashLibNTools/gnucash-viewer/scope.md)".
